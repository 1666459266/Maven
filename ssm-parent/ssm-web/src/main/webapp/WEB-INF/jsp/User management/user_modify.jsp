	...
	<form class="layui-form">
		...
		<div class="layui-col-md4" style="margin-left: 35%; margin-top: 2%">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input id="user_gender" type="radio" name="user_gender" value="man" title="man" checked>
					<input id="user_gender" type="radio" name="user_gender" value="woman" title="woman">
				</div>
			</div>
		</div>
		<div class="layui-col-md4" style="margin-left: 35%; margin-top: 2%">
		...
		<div class="layui-col-md4" style="margin-left: 35%; margin-top: 2%">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="user_telephone" name="user_telehone" required lay-verify="required"
...
<script type="text/javascript"
	src="${path}/static/js/User management/user_modify.js"></script>
<script>
	//JavaScript代码区域
