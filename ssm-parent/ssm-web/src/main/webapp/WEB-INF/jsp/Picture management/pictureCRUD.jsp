...
<script type="text/javascript"
	src="${path}/static/js/Picture management/picture.js"></script>
<script>
	//JavaScript代码区域
...
<script type="text/html" id="imageUrltmp">
<div onclick="show_img(this)" ><img src="{{ d.imageUrl }}" alt="" width="72" height="50"></a></div>
</script>
