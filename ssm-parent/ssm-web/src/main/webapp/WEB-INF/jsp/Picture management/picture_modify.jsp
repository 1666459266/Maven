	...
	<form class="layui-form" style="margin-top: 2%">
		<div class="layui-col-md12" style="margin-top: 3%">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="image_title" required
			...
			<div class="layui-form-item">
				<div class="layui-form-item layui-form-text" style="width:70%">
					...
					<div class="layui-input-block">
						<textarea style="height: 50%" id="image_content" name="desc"
		...
		<div style="margin-top: 3%">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="image_tags" required
...
<script src="${path }/static/js/Picture management/picture_modify.js"></script>
<script>
	//JavaScript代码区域
