	...
	$.fn.lubo = function(options) {
		...
		return this.each(function() {
			...
			function Btn() {
				...
				// _btn.append('<div class="left_btn"><</div><div
				// class="right_btn">></div>');
...
// height:368px; opacity: 0;filter:alpha(opacity=0);}
// .lubo_box li img{ width: 100%; height: 368px;}

// /*圆点*/
// .cir_box{ overflow: hidden; position: absolute; z-index: 100;}
// .cir_box li{ float: left; width: 30px; height: 5px; margin:0 5px; cursor:
// pointer; background: #fff; opacity: 0.8;filter:alpha(opacity=80);}
// .cir_on{ background: #000 !important;}

// /*按钮*/
// .lubo_btn{ position: absolute; width: 100%; top: 140px;}
// .left_btn, .right_btn{ width: 30px; height: 80px; background: #000;opacity:
// 0.8;filter:alpha(opacity=80); cursor: pointer; color: #fff; line-height:
// 80px; font-size: 30px; text-align:
// center;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}
// .left_btn{ float: left;}
...
// <div class="lubo">
// <ul class="lubo_box">
// <li style=" opacity: 1;filter:alpha(opacity=100);"><a href=""><img
// src="1.jpeg"></a></li>
