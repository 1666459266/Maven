function page_ctrl(data_obj) {
  ...
  var per_num=(data_obj.per_num!== undefined)?parseInt(data_obj.per_num):5;//每页显示条数,默认为10条
  ...
  function page_even() {
    ...
    var inp_val=(current_page==total_page)?1:current_page;//跳转页数,input默认显示值
    var append_html='<button class="prev_page">last page</button>';
    ...
    append_html+='<button class="next_page">next page</button><span class="page_total">all '+total_page+' page, arrive</span><input class="input_page_num" type="text" value="'+inp_val+'"><span class="page_text">page</span><button class="to_page_num">define</button>';
