! function(t) {
	function e(e) {
		for (var o, a, u = e[0], c = e[1], f = e[2], s = 0, p = []; s < u.length; s++) a = u[s], r[a] && p.push(r[a][0]), r[a] =
			0;
				...
				return m(e, c["a"]), d(e, [{
					...
					value: function() {
						(y(g(e.prototype), "addLine", this).call(this, {
							...
							color: Object(l.a)(_)
						}).rotation.x = Object(f.a)(0, 2 * Math.PI), Math.random() > .1) && (y(g(e.prototype), "addLine", this).call(
							this, {
